...
if __name__ == '__main__':
    ...
    r3.cmd('route add -net 10.0.1.0 netmask 255.255.255.0 gw 10.0.3.1 dev r3-eth1')
    r2.cmd('route add -net 10.0.2.0 netmask 255.255.255.0 gw 10.0.3.2 dev r2-eth1')
    r2.cmd('route add -net 10.0.1.0 netmask 255.255.255.0 gw 10.0.4.1 dev r2-eth0')
    ...
    r3.cmd('./scripts/disable_ipv6.sh')
