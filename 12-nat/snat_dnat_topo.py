...
if __name__ == '__main__':
	...
	n1.cmd('route add -net 10.22.0.0 netmask 255.255.0.0 gw 159.226.39.44 dev n1-eth1')
	n2.cmd('route add -net 10.21.0.0 netmask 255.255.0.0 gw 159.226.39.43 dev n2-eth0')
